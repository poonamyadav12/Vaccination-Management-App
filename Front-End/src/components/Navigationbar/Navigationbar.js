  ...
  const adminNav = (
    <>
      <Dropdown>
        ...
        <Dropdown.Menu>
          <Dropdown.Item>
            <Link to={{ pathname: "/clinic" }}>New Clinic</Link>
          </Dropdown.Item>
          <Dropdown.Item>
            <Link to={{ pathname: "/disease" }}>New Disease</Link>
          </Dropdown.Item>
          <Dropdown.Item>
            <Link to={{ pathname: "/vaccine" }}>New Vaccine</Link>
          </Dropdown.Item>
          <Dropdown.Item>
            <Link to={{ pathname: "/systemreport" }}>System Report</Link>
          </Dropdown.Item>
        </Dropdown.Menu>
      </Dropdown>
    </>
    ...
    <>
      ...
      <Nav className="ml-auto">
        {!user && (
          ...
          >
            <Button className="mr-sm-2 navbarbuttons">Sign Up</Button>
          </Link>
        )}
        {!user ? (
          <Link
          ...
          >
            <Button className="mr-sm-2 navbarbuttons">Login</Button>
          </Link>
        ) : (
          <>
            {admin && adminNav}
            ...
            >
              <Button className="mr-sm-2 navbarbuttons">Appointments</Button>
            </Link>
            <Link
              id="appointments"
              to={{
            ...
            >
              <Button className="mr-sm-2 navbarbuttons">Patient Report</Button>
            </Link>
            <Link
              id="logout"
              to={{
            ...
            >
              <Button className="mr-sm-2 navbarbuttons" onClick={handleLogout}>
                Logout
              </Button>
            </Link>
          </>
